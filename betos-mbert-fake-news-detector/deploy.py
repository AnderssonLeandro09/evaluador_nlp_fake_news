"""
Deployment scripts and configuration for Fake News Detection API

This module contains deployment scripts and configuration files for
the BETO and mBERT model comparison platform.
"""
